...
public class DiaDia {
	...
	private void prendi(String nomeAttrezzo) {
		Attrezzo a = this.labirinto.getStanzaCorrente().getAttrezzo(nomeAttrezzo);
		this.labirinto.getStanzaCorrente().removeAttrezzo(a);
	...
	private void posa(String nomeAttrezzo) {
			Attrezzo a = this.giocatore.getBorsa().getAttrezzo(nomeAttrezzo);
			this.giocatore.getBorsa().removeAttrezzo(nomeAttrezzo);
			this.labirinto.getStanzaCorrente().addAttrezzo(a);
		}
